...
export class LoadScene extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.audio("DemonDeath", "./assets/DemonDeath.mp3");
        this.load.audio("jump", "./assets/jump.wav");
        this.load.audio("swordSwing", "./assets/swordSwing.mp3");
        this.load.audio("keyCollected", "./assets/keyCollected.wav");
        this.load.audio("keyNotCollected", "./assets/keyNotCollected.wav");
        this.load.audio("keyAllowed", "./assets/keyAllowed.mp3");
        ...
        this.load.spritesheet("SKELLYRANGED", "./assets/IceSkeleton.png", {
            frameHeight: 120,
            frameWidth: 250
        } );

        this.load.spritesheet("SPEARSKELLY", "./assets/SpearSkelly.png", {
            frameHeight: 120,
            frameWidth: 300
        } );
